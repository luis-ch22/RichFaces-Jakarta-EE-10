...
This is based on RichFaces 4.6.x (itself derived from the discontinued
JBoss RichFaces 4.5), migrated to build and run on *Java 21*. Group id changed to `com.github.luisch22.richfaces`. See
