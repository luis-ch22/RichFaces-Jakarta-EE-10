...
RichFaces 5.0.0 (Java 21) image:https://github.com/luis-ch22/RichFaces_Java_21/actions/workflows/build.yml/badge.svg[alt="Build Status", link="https://github.com/luis-ch22/RichFaces_Java_21/actions/workflows/build.yml"]
...
https://github.com/luis-ch22/RichFaces_Java_21[luis-ch22/RichFaces_Java_21].
...
* https://github.com/luis-ch22/RichFaces_Java_21/issues[Issue Tracker]
* https://developer.jboss.org/en/richfaces/content[User Forums]
* https://github.com/luis-ch22/RichFaces_Java_21/actions/workflows/build.yml[Continuous Integration] image:https://github.com/luis-ch22/RichFaces_Java_21/actions/workflows/build.yml/badge.svg[alt="Build Status", link="https://github.com/luis-ch22/RichFaces_Java_21/actions/workflows/build.yml"]
...
Alternatively, if you are not using maven, you can download the project ZIP distribution from the https://github.com/luis-ch22/RichFaces_Java_21/releases[Download Page] and manually include the dependencies in your classpath.
...
=== Clone the Project
    ...
    $ git clone https://github.com/luis-ch22/RichFaces_Java_21.git
